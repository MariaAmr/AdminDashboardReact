    ...
    >
      <div className="container mx-auto px-4 sm:px-0 md:px-20 dark:bg-gray-700 ">
        <div className="-mx-4 flex flex-wrap lg:justify-between py-5">
          ...
          >
            <div className="relative rounded-lg bg-white dark:bg-gray-600 p-8 shadow-lg dark:bg-dark-2 sm:p-12">
              <form>
                <ContactInputBox
                  type="text"
                  name="name"
                ...
                >
                  <button
                    type="submit"
                    className="w-full rounded border border-primary bg-primary p-3 text-white dark:bg-black/[0.90] transition hover:bg-opacity-90"
                  >
                    Send Message
                  </button>
                </motion.div>
              ...
              <div>
                ...
                <motion.span className="absolute -right-10 top-[90px] ">
                  <motion.svg
                    width={34}
                    height={134}
                    viewBox="0 0 34 134"
                ...
                <motion.span className="absolute -bottom-7 -left-7 ">
                  <svg
                    width={107}
                    height={134}
                    viewBox="0 0 107 134"
